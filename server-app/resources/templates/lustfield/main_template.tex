...
\begin{document}
  ...
  \documentTitle{John Doe}{
    ...
    \href{mailto:user@domain.tld}{\raisebox{-0.15\height} \faEnvelope\ USER@domain.tld} ~ | ~
    \href{https://linkedin.com/in/USER/}{\raisebox{-0.15\height} \faLinkedin\ linkedin.com/in/USER} ~ | ~
    \href{https://github.com/USER}{\raisebox{-0.15\height} \faGithub\ github.com/USER} ~ | ~
    {\raisebox{-0.15\height} \faGlobe\ Hindi, English}
  }
  ...
  \headingIt{Senior DevOps Engineer}{}
  \begin{resume_list}
  ...
  \headingIt{Senior Systems Administrator}{}
  \begin{resume_list}
  ...
  \headingBf{State University}{Feb 2011 -- Mar 2016} % Note: Adding year(s) exposes an implied age
...
%-----------%
  ...
  \headingBf{Certificate}{Feb 2011 -- Mar 2016} % Note: Adding year(s) exposes an implied age
  \headingIt{Organization}{}
  \vspace{5pt}
