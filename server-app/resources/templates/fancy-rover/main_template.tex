...
\begin{center}
    ...
    {\color{icnclr}\faEnvelope[regular]} \href{mailto:hi@example.com}{user@live.com} $|$ 
    {\color{icnclr}\faIcon{mobile-alt}} \href{tel:1234567890}{123 456 7890} $|$
    {\color{icnclr}\faLinkedinIn} \href{https://www.linkedin.com/}{linkedin.com/in/USER} $|$ 
    {\color{icnclr}\faGithub} \href{https://github.com/}{https://github.com/USER}
\end{center}
...
\section{Education}
%==============
\subsection{University of Location $|$ {\normalfont\textit{Master of PG Degree}} \hfill 01-01-2020 | 31-12-2023}
\begin{itemize}
